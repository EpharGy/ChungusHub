...
The workflow must end in a node that saves an image (`SaveImage`, or anything that reports
images in ComfyUI's history). The engine takes the first image the finished job reports.
